...
![Manifest Upload](./redhat_subscription_manifest_upload.png)
...
![Enable Red Hat Repos Initial](./enable_redhat_repositories_initial.png)
![Enable Red Hat Repos Selected](./enable_redhat_repositories_selected_repos.png)
