...
![Creating a product](./product_create.png)
...
![Creating a Repository](./repo_create.png)
...
![Syncing a Repository](./repo_sync.png)

The progress will be displayed:

![Sync progress](./repo_sync_progress.png)
...
![Multi Sync](./repo_sync_multi.png)
...
![Creating a puppet repo](./repo_create_puppet.png)
...
![Uploading a puppet module](./puppet_upload.png)
...
![Creating a Sync Plan](./sync_plan_assign.png)
