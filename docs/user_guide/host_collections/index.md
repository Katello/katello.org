...
![Creating a Host Collection](./host_collection_create.png)
...
![Adding Content Hosts to a Host Collection](./host_collection_add_hosts.png)
...
![Copy a Host Collection](./host_collection_copy.png)
...
![Host collection actions](./host_collection_actions.png)

Note: clicking on an action will take the user to the appropriate Content Hosts Bulk Actions page, where all Content Hosts associated with the collection have been selected.  [Click here, for more information on performing Content Host Bulk Actions](../content_hosts/index.html#bulk-actions)
