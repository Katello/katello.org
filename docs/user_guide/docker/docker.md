...
Content can be synced into Katello using a Red Hat manifest in much the same way as yum content. See [our guide on how to manage Red Hat content for more information](../red_hat_content/content.html).
...
See how to provision content in the documentation in the [foreman-docker documentation](http://theforeman.org/documentation.html). Provisioning content from Katello works in much the same way.
