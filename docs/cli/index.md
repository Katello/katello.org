...
yum -y localinstall http://yum.theforeman.org/{{ site.version }}/el6/x86_64/foreman-release.rpm
...
yum -y localinstall http://yum.theforeman.org/{{ site.version }}/el7/x86_64/foreman-release.rpm
